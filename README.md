...
### Changes
[v2.0.6] Tiny update  
Removed temp local variables. All is now hidden inside `global.FEDATA`. Also it should theoretically speed it up since I also switched back from a struct to an array  
